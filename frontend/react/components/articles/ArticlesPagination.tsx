import {ArticlesPaged} from "../../api/types";

export default function ArticlesPagination(articlesPaged: ArticlesPaged) {
  let currentPage = articlesPaged.currentPage;
  let totalPages = articlesPaged.totalPages;
  return (
    <>
      ...
      <nav aria-label="Articles pagination">
        <ul className="inline-flex -space-x-px">
          <li>
            <a href={`/?page=${currentPage - 1 > 0 ? currentPage - 1 : 0}`}
          ...
          <li>
            <a href={`/?page=${currentPage + 1 > totalPages ? totalPages : currentPage + 1}`}
